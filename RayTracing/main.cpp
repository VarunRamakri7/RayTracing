...
int main()
{
	...
	auto material_center = make_shared<metal>(color(0.1, 0.2, 0.5), 0.7);
	...
	world.add(make_shared<sphere>(point3(-1.0, 0.0, -1.0), -0.4, material_left)); // Use negative radius for hollow sphere
